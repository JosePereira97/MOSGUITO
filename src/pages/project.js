...
const Header = () => {
  return (
    <header className="header">
      <Typography variant="h4">MOSCA</Typography>
...
const Main = () => {
  ...
  return (
    <>
      ...
      <Card className={classes.root}>
        <CardContent>
          <b>MOSCA</b> is a command-line pipeline for performing metagenomics,
          metatranscriptomics and metaproteomics analysis.
          ...
          <Button
            ...
            startIcon={
              <Avatar
                src={
                  "https://user-images.githubusercontent.com/1506863/49924558-986f5d80-feae-11e8-8398-7cddbf834ffe.png"
                }
                size="2em"
              />
            }

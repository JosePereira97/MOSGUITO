...
const Header = () => {
  return (
    <header className="header">
      ...
      <Typography variant="h6">My Inputs</Typography>
    </header>
  );
};
...
const Main = () => {
  ...
  useState(() => {
    axios
      .post("http://127.0.0.1:5002/Get_my_inputs", formData, {
  ...
  const DeleteFiles = () => {
    ...
    axios
      .post(
        "http://127.0.0.1:5002/Get_my_inputs/Delete_Files",
        formDataDelete,
        {
          withCredentials: true,
        }
  ...
  const DownloadFiles = () => {
    ...
    axios
      .post(
        "http://127.0.0.1:5002/Get_my_inputs/Download_Files",
        formDataDownload,
        {
          withCredentials: true,
        }

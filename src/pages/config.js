      ...
      <form className="form">
        <Card>
          ...
          >
            ...
            <Button variant="outlined">MOSCA {configData.version}</Button>
          </CardActions>
          ...
          <CardContent>
            ...
            <LabelledTextField
              ...
              onChange={(ev) =>
                onConfigChange("resourcesDirectory", ev.target.value)
              }
            ...
            <LabelledNumberField
              ...
              onChange={(ev) =>
                onConfigChange("threads", ev.target.valueAsNumber)
              }
            ...
            <LabelledNumberField
              ...
              onChange={(ev) =>
                onConfigChange("maxMemory", ev.target.valueAsNumber)
              }
            ...
            <LabelledTextField
              ...
              onChange={(ev) =>
                onConfigChange("suffix", ev.target.valueAsNumber)
              }
            ...
            <Typography variant="h6">Preprocessing settings</Typography>

            <LabelledNumberField
              label="Minimum read length"
              value={configData.minimumReadLength}
              onChange={(ev) =>
                onConfigChange("minimumReadLength", ev.target.valueAsNumber)
              }
            ...
            <Typography variant="h6">Assembly settings</Typography>

            <LabelledCheckbox
              label="Perform assembly"
              checked={configData.doAssembly}
              setChecked={(ev) =>
                onConfigChange("doAssembly", ev.target.checked)
              }
            ...
            {configData.doAssembly ? (
              <>
                <LabelledSelect
                  ...
                  onChange={(ev) =>
                    onConfigChange("assembler", ev.target.value)
                  }
                ...
                <Typography variant="h6">Binning settings</Typography>

                <LabelledCheckbox
                  label="Perform iterative binning"
                  checked={configData.doIterativeBinning}
                  setChecked={(ev) =>
                    onConfigChange("doIterativeBinning", ev.target.checked)
                  }
                ...
                <LabelledSelect
                  ...
                  onChange={(ev) =>
                    onConfigChange("markerset", ev.target.value)
                  }
            ...
            <Typography variant="h6">Annotation settings</Typography>
            ...
            <LabelledSelect
              ...
              onChange={(ev) =>
                onConfigChange("upimapiDatabase", ev.target.value)
              }
            ...
            {configData.upimapiDatabase === "taxids" ? (
              <LabelledTextField
                ...
                onChange={(ev) =>
                  onConfigChange("upimapiTaxids", ev.target.value)
                }
            ...
            <LabelledNumberField
              ...
              onChange={(ev) =>
                onConfigChange("diamondMaxTargetSeqs", ev.target.valueAsNumber)
              }
            ...
            <LabelledCheckbox
              ...
              setChecked={(ev) =>
                onConfigChange("downloadCddResources", ev.target.checked)
              }
            ...
            {hasMt ? (
              <>
                <LabelledSelect
                  ...
                  onChange={(ev) =>
                    onConfigChange("normalizationMethod", ev.target.value)
                  }
            ...
            <Typography variant="h6">Proteomics settings</Typography>
            ...
            {hasMp ? (
              <>
                <LabelledSelect
                  ...
                  onChange={(ev) =>
                    onConfigChange("proteomicsWorkflow", ev.target.value)
                  }
                ...
                <LabelledCheckbox
                  ...
                  setChecked={(ev) =>
                    onConfigChange("useCrap", ev.target.checked)
                  }
                ...
                {configData.protease !== "File" ? (
                  ...
                  <LabelledTextField
                    ...
                    onChange={(ev) =>
                      onConfigChange("proteaseFile", ev.target.value)
                    }
            ...
            <Typography variant="h6">KEGG metabolic maps settings</Typography>

            <LabelledSelect
              label="KEGG maps taxonomic level"
              value={configData.keggcharterTaxaLevel}
              onChange={(ev) =>
                onConfigChange("keggcharterTaxaLevel", ev.target.value)
              }
